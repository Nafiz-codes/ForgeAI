...
export default function ResultsPage() {
    ...
    return (
      <main style={{ minHeight: "100vh", background: "var(--bg-primary)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px" }}>
        <div style={{ textAlign: "center", maxWidth: "420px" }}>
          <h1 style={{ fontSize: "24px", fontWeight: 800, marginBottom: "14px", letterSpacing: "-0.02em" }}>
            No results found
          </h1>
  ...
  // ── Before / After table rows derived from real data ─────────────────────
      ...
      <div style={{ maxWidth: "1060px", margin: "0 auto", padding: "44px 36px" }}>
        ...
        >
          <div>
            <h1 style={{ fontSize: "20px", fontWeight: 800, letterSpacing: "-0.02em", marginBottom: "5px" }}>
              <code style={{ fontFamily: "'JetBrains Mono', monospace", color: "#67e8f9" }}>
        ...
        <div
          style={{
            ...
            justifyContent: "space-around", flexWrap: "wrap", gap: "20px",
          }}
        >
          <HealthRing score={results.health_score_before} label="Before" color="#e11d48" />
          ...
          <HealthRing score={results.health_score_after}  label="After"  color="#059669" />
          <div style={{ width: "1px", background: "var(--border-subtle)", height: "70px", alignSelf: "center" }} />
          <HealthRing score={results.completeness_score}  label="Completeness" color="#2563eb" />
          <HealthRing score={results.consistency_score}   label="Consistency"  color="#7c3aed" />
          <HealthRing score={results.ml_readiness_score}  label="ML readiness" color="#0ea5e9" />
        </div>
        ...
        <div
          style={{
            ...
            padding: "3px", width: "fit-content", border: "1px solid var(--border)",
          }}
        >
          {TABS.map((tab) => (
            <button
        ...
        {activeTab === "overview" && (
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "16px" }}>
            ...
            {/* Downloads */}
            <div style={{ borderRadius: "12px", border: "1px solid var(--border)", background: "var(--bg-card)", overflow: "hidden" }}>
              <div style={{ padding: "12px 18px", borderBottom: "1px solid var(--border)", background: "var(--bg-secondary)" }}>
                ...
                {([
                  ...
                  <div
                    ...
                    style={{
                      ...
                      marginBottom: "6px", cursor: "pointer", background: "transparent",
                    }}
                  >
                    <div
                      style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: "12px", fontWeight: 600, fontFamily: "'JetBrains Mono', monospace", color: "#93c5fd", marginBottom: "2px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                        {f.label}
                      </div>
        ...
        {activeTab === "log" && (
          <div style={{ borderRadius: "12px", border: "1px solid var(--border)", overflow: "hidden", background: "var(--bg-card)" }}>
            <div style={{ padding: "12px 18px", borderBottom: "1px solid var(--border)", display: "flex", justifyContent: "space-between", alignItems: "center", background: "var(--bg-secondary)" }}>
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    color: "#93c5fd", fontSize: "12px", fontWeight: 500, cursor: "pointer",
                  }}
                >
                  Download
                </button>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {results.ml_recommendations.map((m: MlRecommendation, rank: number) => {
              ...
              return (
                ...
                >
                  <div style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: "2px", background: color, opacity: 0.7 }} />
                  <div
                    style={{
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: "flex", gap: "8px", alignItems: "center", marginBottom: "7px", flexWrap: "wrap" }}>
                      <h3 style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "-0.01em" }}>{m.model}</h3>
